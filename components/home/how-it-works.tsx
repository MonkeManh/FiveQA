    ...
    <section className="py-40 flex justify-center bg-gradient-to-b from-background to-muted/30">
      <div className="container px-4 md:px-6">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold tracking-tighter mb-2">How FiveQA Works</h2>
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="bg-card rounded-lg p-6 border shadow-sm w-full">
              ...
              <p className="text-muted-foreground text-center">
                Dispatcher receives emergency call and enters initial information into FiveQA
              </p>
            </div>
          </div>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 bg-card rounded-lg p-4 border shadow-sm">
            ...
            <span className="text-sm font-medium">
              FiveQA reduces response times by up to 30% and improves outcome accuracy
            </span>
          </div>
        </div>
      </div>
